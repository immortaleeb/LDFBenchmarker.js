...
function run {
  ...
  ./run-tests.js ./stress-workloads/watdiv-stress-100/$1.sparql http://localhost:3002/watdiv100M $timeout ldf-client-joachim > ./output/$1-amq.csv
  ./run-tests.js ./stress-workloads/watdiv-stress-100/$1.sparql http://localhost:3003/watdiv100M $timeout ldf-client-joachim > ./output/$1-amq-delayed.csv
}
